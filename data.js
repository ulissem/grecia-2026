...
window.GUIDE = {
  ...
  text: {
    ...
    <div class="card"><h3>Venerdì 16: volo delle 11:45</h3><ul class="small">
      ...
      <li>Hotel con garage e colazione dalle 7:30: chiedilo alla prenotazione.</li></ul></div>`
  },
  ...
  ui_ess: { expand_all: "Apri tutto", collapse_all: "Chiudi tutto", nav_short: "Naviga", on_foot: "Giornata a piedi, auto in garage", e_title: "Il paese in breve", e_signs: "I cartelli che vedrai", e_alpha: "L'alfabeto, per leggere le insegne", e_fuel: "Calcolo carburante", e_km: "km", e_cons: "l/100 km", e_price: "€/l", e_res: "costo stimato" },
  ...
  { id: "d2", date: "2026-10-13", chip: ["Mar 13", "→ Nafplio"], title: "Olimpia → Nafplio, attraverso l'Arcadia", place: "nafplio", night: "Nafplio", hero: "Nafplio",
    ...
    sleep: { city: "Nafplio", ci: "2026-10-13", co: "2026-10-14", txt: "Una notte nel centro storico, a piedi da tutto. Amfitriti Palazzo e Pension Marianna (la colazione in terrazza è famosa) sotto Acronauplia; 3Sixty e Ippoliti più eleganti; Aetoma in una piazzetta silenziosa. Prenota adesso: nei weekend d'autunno la città è piena." },
  ...
  { id: "d3", date: "2026-10-14", chip: ["Mer 14", "Argolide → Atene"], title: "Micene, Epidauro, pranzo a mare, poi Atene", place: "atene", night: "Atene", hero: "Mycenae",
    ...
    routeNote: "Caffè in piazza Syntagma alle 8, quando Nafplio è ancora vuota. Partenza 8:30, Micene all'apertura. Dopo pranzo la costiera fino a Isthmia, sosta al canale, poi A8 e Attiki Odos (pedaggi ~€8). Hotel a Koukaki per le 17:30: auto in garage, non la tocchi più fino a venerdì.",
    ...
    stops: [
      ...
      { name: "Atene, primo impatto", time: "17:30", dur: "la sera", lat: 37.9680, lng: 23.7210, wiki: "Philopappos Monument", wit: "Collina di Filopappo", nav: "Filopappou Hill",
        desc: "Auto in garage, doccia, e a piedi sulla collina di Filopappo, 15 minuti dall'hotel: il tramonto sull'Acropoli è alle 18:45, senza biglietto e senza folla. Poi cena a Koukaki.",
    ...
    sleep: { city: "Athens", ci: "2026-10-14", co: "2026-10-16", txt: "Due notti a Koukaki o Makrygianni, sotto il Museo dell'Acropoli: filtra per 'parcheggio', ad Atene è indispensabile. Herodion e Acropolis Hill sono le scelte classiche, Coco-Mat Athens BC ha il rooftop sul Partenone. Chiedi se puoi lasciare l'auto in garage fino a venerdì mattina." },
  ...
  { id: "d4", date: "2026-10-15", chip: ["Gio 15", "Atene"], title: "Atene, vissuta", place: "atene", night: "Atene", hero: "Acropolis of Athens",
    ...
    legs: [],
    routeNote: "Tutto a piedi da Koukaki, al massimo un taxi. L'unica prenotazione della giornata è l'Acropoli alle 16:00 su tickets.hh.gr. Pieno di benzina stasera o domattina a Koropi, sulla strada dell'aeroporto.",
    ...
    stops: [
      ...
      { name: "Pausa", time: "14:30", dur: "1 h 30", lat: 37.9660, lng: 23.7280, wiki: "Koukaki", wit: "Koukaki", nav: "Koukaki Athens",
        desc: "Hotel, doccia, un'ora di niente. Alle tre del pomeriggio ad Atene fa ancora caldo e l'Acropoli alle 16 vuole gambe fresche.",
      ...
      { name: "Sera a Psyrri", time: "20:30", dur: "fino a quando vuoi", lat: 37.9787, lng: 23.7250, wiki: "Psyri", wit: "Psyrri", nav: "Psyrri Athens",
        desc: "Metro o 20 minuti a piedi. Cena in taverna, loukoumades da Krinos o Lukumades, e un ultimo giro a Monastiraki con l'Acropoli illuminata sopra i tetti.",
    ...
    sleep: { city: "Athens", ci: "2026-10-14", co: "2026-10-16", txt: "Stessa camera di ieri. Check-in online per il volo di domani, valigia pronta, sveglia alle 7:30." },
  ...
  { id: "d5", date: "2026-10-16", chip: ["Ven 16", "volo 11:45"], title: "Colazione e aeroporto", place: "atene", night: "—", hero: "Athens International Airport",
    ...
    routeNote: "Partenza dall'hotel alle 8:45: Syngrou o Vouliagmenis fino all'Attiki Odos, pedaggio €2,80, uscita aeroporto. Pieno a Koropi lungo la strada. Riconsegna seguendo 'Car rental return' entro le 9:30, banco Lufthansa alle 9:45. Se il traffico delle 9 ti preoccupa, parti alle 8:30.",
    ...
    stops: [
      { name: "Colazione a Koukaki", time: "7:45", dur: "30 min", lat: 37.9640, lng: 23.7285, wiki: "Koukaki", wit: "Koukaki", nav: "Overoll croissanterie Athens",
        desc: "Overoll per un cornetto o Takis per la tiropita, un freddo espresso, e la valigia in macchina.",
  ...
  budget: [["Benzina, ~700 km × 7 l/100 × €2,15", "≈ €105"], ["Pedaggi (ponte €15,90 + autostrade)", "≈ €35"], ["Ingressi a siti e musei", "≈ €150"], ["Hotel, 4 notti (Olimpia, Nafplio, Atene ×2)", "€360–520"], ["Pasti e caffè", "≈ €40/giorno"]],
  ...
  todo: [
    ...
    ["Hotel Nafplio, 13 ottobre (una notte)", "prima di tutti gli altri", "https://www.booking.com/searchresults.html?ss=Nafplio&checkin=2026-10-13&checkout=2026-10-14&group_adults=1&no_rooms=1"],
    ...
    ["Hotel Atene con parcheggio, 14–16 ottobre (due notti)", "Koukaki / Makrygianni", "https://www.booking.com/searchresults.html?ss=Koukaki+Athens&checkin=2026-10-14&checkout=2026-10-16&group_adults=1&no_rooms=1"],
